...
export default function AdminAgentOperationsPage({ user }) {
  ...
  const approveAndRun = async () => {
    ...
    const response = await apiRequest(`/api/admin/agents/runs/${selected.run.id}/approve-and-run`, { method: 'POST', body: { actionIds, executionMode: presentationPaced ? 'presentation_paced' : 'live' } });

...
const { requireBookedAppointment } = require('../middleware/appointment-state');
...
router.post('/:appointmentId/end', authRequired, roleRequired('doctor', 'admin'), requireBookedAppointment, appointmentsController.endAppointment);
